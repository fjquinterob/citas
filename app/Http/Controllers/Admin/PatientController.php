...
class PatientController extends Controller
{
    ...
    {       // si se quiere paginar el listado de paciente se usa (paginate)
    ...
    public function store(Request $request)
    {
        ...
        User::create($request->only('name', 'email', 'cédula', 'address', 'phone')
            + [
                'role' => 'patient',
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->only('name', 'email', 'cédula', 'address', 'phone');
